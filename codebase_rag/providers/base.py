...
from pydantic_ai.models.openai import ModelRequest
...
class AzureProvider(ModelProvider):
    ...
    def __init__(
        ...
        api_key: str | None = None,
        endpoint: str = "https://openai-east-us-wp.openai.azure.com",
        **kwargs: Any,
    ) -> None:
        super().__init__(**kwargs)
    ...
    def create_model(self, model_id: str, **kwargs: Any) -> OpenAIResponsesModel:
        ...
        # provider = AzureProvider(api_version=self.api_version, api_key=self.api_key, endpoint=self.endpoint, openai_client=client)
        return OpenAIResponsesModel('gpt-4o', provider=provider, **kwargs)
