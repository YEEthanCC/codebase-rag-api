...
from ..codebase_rag.tools.file_extension_reader import FileReader
from ..codebase_rag.tools.file_extension_writer import FileWriter
from ..codebase_rag.tools.file_extension_editor import FileEditor
from..codebase_rag.tools.shell_extension_command import ShellCommander
...
def _initialize_services_and_agent(repo_path: str, ingestor: MemgraphIngestor, socket_id: str) -> Any:
    ...
    file_reader = FileReader(socket_id=socket_id)
